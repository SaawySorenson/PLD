...
#
# Generated by Vivado on Wed Apr 03 13:24:59 +0200 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ILA_PWM xil_defaultlib.ILA_PWM xil_defaultlib.glbl -log elaborate.log
}
