...
HD_PWD='C:/Temp/xsvece00/PLD/CV8/PC_07.runs/ILA_BTN_SW_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ILA_BTN_SW.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ILA_BTN_SW.tcl
