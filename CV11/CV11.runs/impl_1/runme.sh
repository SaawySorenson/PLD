...
HD_PWD='C:/Temp/xsvece00/PLD/CV11/CV11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_blockdesign_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zync_blockdesign_wrapper.tcl -notrace
