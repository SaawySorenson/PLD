...
HD_PWD='C:/Temp/xsvece00/PLD/CV11/CV11.runs/zync_blockdesign_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_blockdesign_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zync_blockdesign_auto_pc_0.tcl
