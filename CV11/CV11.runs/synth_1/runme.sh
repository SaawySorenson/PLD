...
HD_PWD='C:/Temp/xsvece00/PLD/CV11/CV11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zync_blockdesign_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zync_blockdesign_wrapper.tcl
